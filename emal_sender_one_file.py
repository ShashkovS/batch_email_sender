...
from PyQt5.Qt import QApplication, QBrush, QColor, QDialog, QFileDialog, QListWidgetItem, QMainWindow, QObject, Qt, QThread, pyqtSignal, pyqtSlot
from PyQt5.QtWidgets import QGridLayout, QFormLayout, QLineEdit, QLabel, QCheckBox, QDialogButtonBox, QWidget, \
    QPushButton, QListWidget, QTextBrowser, QSizePolicy, QMenuBar, QStatusBar, QMessageBox
...
def set_ok(xls_name, row_num_real):
    while True:
        try:
            ...
            raise Exception(
                f'Файл {xls_name} заблокирован. Сохраните и закойте его. В него будут вноситься отметки об успешности отправки')
            # continue
...
def rtv_table_and_template(xls_name, template_name):
    ...
    try:
        ...
        raise Exception(
            f'В таблице {xls_name} должен быть столбец {e!s}, так как он упоминается в шаблоне {template_name}')
        ...
        if attach_cols:
            ...
            for attach_key in attach_cols:
                ...
                if attach_name and not os.path.isfile(attach_name):
                    raise Exception(
                        f'В таблице {xls_name} в строчке {rn+ONE_PLUS_ONE_FOR_HEADER} в столбце {attach_key} указано вложение "{attach_name}". Этот файл не найден')
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.line_email)
        ...
        self.line_sender = QLineEdit(Dialog)
        self.line_sender.setObjectName("line_sender")
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.line_sender)
        self.label_4 = QLabel(Dialog)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.label_4)
        self.line_smtpserver = QLineEdit(Dialog)
        self.line_smtpserver.setObjectName("line_smtpserver")
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.line_smtpserver)

        self.label_5 = QLabel(Dialog)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.label_5)
        self.line_send_copy = QLineEdit(Dialog)
        self.line_send_copy.setObjectName("line_send_copy")
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.line_send_copy)

        self.label_6 = QLabel(Dialog)
        self.label_6.setObjectName("label_6")
        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.label_6)

        self.save_passw_cb = QCheckBox(Dialog)
        self.save_passw_cb.setObjectName("save_passw_cb")
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.save_passw_cb)
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_ask_and_send = QPushButton(self.centralwidget)
        ...
        self.pushButton_cancel_send = QPushButton(self.centralwidget)
        ...
        self.listWidget_emails = QListWidget(self.centralwidget)
        ...
        self.gridLayout.setObjectName("gridLayout")
        self.pushButton_open_list_and_template = QPushButton(self.centralwidget)
        ...
        self.listWidget_attachments = QListWidget(self.centralwidget)
        ...
        self.listWidget_attachments.setMinimumSize(QSize(0, 75))
